<template>
  <div class="grid gap-6 lg:grid-cols-3">
    <div class="custom-shadow rounded-lg bg-white p-6 dark:bg-gray-800 lg:col-span-2">
      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Informations générales</h2>
    ...
    <div class="custom-shadow rounded-lg bg-white p-6 dark:bg-gray-800">
      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Le maire</h2>
    ...
    <div class="custom-shadow rounded-lg bg-white p-6 dark:bg-gray-800 lg:col-span-3">
