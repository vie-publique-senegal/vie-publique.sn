  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="mx-auto max-w-6xl">
        ...
        <div class="flex items-center justify-between gap-4">
          ...
          <div
            ...
            class="flex items-center gap-1.5 rounded-full bg-sky-50 px-3 py-1.5 dark:bg-sky-900/30"
          >
    ...
    <div class="mx-auto max-w-6xl px-4 pb-24 pt-4 md:pt-0">
      ...
      <AppErrorState
        v-else-if="error"
        :error="error"
        title="Groupes parlementaires indisponibles"
        message="La liste des groupes parlementaires n'a pas pu être chargée."
        retryable
        @retry="refresh"
      />
      ...
      <div v-else class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <AssemblyGroupCard v-for="group in groups" :key="group.id" :group="group" />
      </div>
...
const { groups, loading, error, refresh } = useAssemblyGroups();
</script>
