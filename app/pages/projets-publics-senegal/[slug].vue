    ...
    <div class="container mx-auto px-4 py-6">
      ...
      <div v-else-if="project" class="space-y-6">
        ...
        >
          ...
          <div class="prose prose-sm max-w-none prose-p:text-gray-600 prose-strong:text-gray-900 prose-li:text-gray-600 dark:prose-p:text-gray-300 dark:prose-strong:text-white dark:prose-li:text-gray-300 dark:prose-headings:text-white" v-html="rewriteCmsContent(project.description)" />
        </div>
