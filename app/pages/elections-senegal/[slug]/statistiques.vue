...
if (import.meta.client && route.query.stats_type) {
        ...
        <template v-if="statsType === 'professionCandidat'">
          ...
          <div v-else class="flex flex-col items-center justify-center py-20 text-center">
            <UIcon
              ...
              class="mx-auto mb-4 h-16 w-16 text-gray-200 dark:text-gray-700"
            />
            <h4 class="mb-1 text-lg font-bold text-gray-400">Aucune donnée de profession</h4>
            <p class="max-w-sm text-sm text-gray-500">
              Les informations sur les professions des candidats ne sont pas encore disponibles pour
              cette élection.
            </p>
          </div>
        </template>
