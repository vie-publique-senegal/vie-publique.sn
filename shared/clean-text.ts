/**
 * Nettoyage de texte issu du CMS pour un usage SAFE dans les meta / JSON-LD / flux RSS.
 *
 * SOURCE DE VÉRITÉ partagée entre :
 * - app/composables/useCleanText.ts (meta SEO & JSON-LD, ré-export)
 * - server/utils/rss.ts (descriptions des items RSS)
 *
 ...
 * CMS injectée dans `useSeoMeta`, un JSON-LD ou un flux RSS.
 */
