...
- [elections-geo-resolution.md](./elections-geo-resolution.md) - résolution des noms contre le référentiel géographique versionné (`geo_entities` et collections associées)
