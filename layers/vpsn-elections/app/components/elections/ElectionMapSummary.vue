...
// useElectionsConfig est auto-importé par Nuxt
...
<template>
  ...
  <!-- Sections -->
  <div v-for="section in summaryData" :key="section.title" class="mb-4 mt-2 space-y-2">
    <!-- Titre de section avec barres -->
    <div class="flex items-center justify-center gap-4 px-4">
      <div :class="`h-px w-full bg-${section.color}-300`"></div>
