...
export default defineCachedEventHandler(
  async (event) => {
    ...
    try {
      ...
      const communes = allConstituencies.filter((c: any) => c.type === 'national' && c.nazionale_type === 'commune');
      ...
      lists.forEach((list: any) => {
        ...
        } else if ((constitDef.type === 'national' && constitDef.nazionale_type === 'commune') && constitDef.parent) {
